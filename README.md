...
```bash
git clone https://aur.archlinux.org/mint-backgrounds-nadia.git
cd mint-backgrounds-nadia
makepkg
```
...
```bash
yay --sync --aur mint-backgrounds-nadia
```
...
sudo pacman --sync mint-backgrounds-nadia
```
